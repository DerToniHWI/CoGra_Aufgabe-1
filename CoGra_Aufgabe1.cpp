...
// CoGra_Aufgabe1.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CCoGraAufgabe1App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CCoGraAufgabe1App::OnAppAbout)
END_MESSAGE_MAP()


// CCoGraAufgabe1App-Erstellung

CCoGraAufgabe1App::CCoGraAufgabe1App() noexcept
{
	...
	SetAppID(_T("CoGraAufgabe1.AppID.NoVersion"));

	// TODO: Hier Code zur Konstruktion einfügen
	// Alle wichtigen Initialisierungen in InitInstance positionieren
}

// Das einzige CCoGraAufgabe1App-Objekt

CCoGraAufgabe1App theApp;


// CCoGraAufgabe1App-Initialisierung

BOOL CCoGraAufgabe1App::InitInstance()
{
...
int CCoGraAufgabe1App::ExitInstance()
{
...
// CCoGraAufgabe1App-Meldungshandler
...
void CCoGraAufgabe1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
